...
export default class ScreenTheme extends Component {
    constructor(props){
        super(props)
    ...
    onSelectTheme = (themeKey) => {
        ...
        DeviceEventEmitter.emit('ACTION_BASE',ACTION_HONE.A_THEME,ThemeFactory.createTheme(ThemeFlags[themeKey]))
    }
    getThemeItem = (themeKey) => {//创建主题item
        return(
